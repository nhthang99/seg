...
class EarlyStopping(ignite.handlers.EarlyStopping, Module):
    '''
        ...
        Parameters:
            ...
            mode (str): one of min, max. In min mode, running process will be stopped when
                        the quantity monitored has stopped decreasing;
                        in max mode it will be stopped when the quantity monitored has stopped increasing.
    ...
    def __init__(self, patience, score_name, evaluator_name, mode='max'):
        ...
        super(EarlyStopping, self).__init__(patience, score_function=best_score,
